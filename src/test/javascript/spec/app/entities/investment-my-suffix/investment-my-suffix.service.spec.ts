...
describe('Service Tests', () => {
    ...
    describe('InvestmentMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(InvestmentMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/investments';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InvestmentMySuffix', () => {
