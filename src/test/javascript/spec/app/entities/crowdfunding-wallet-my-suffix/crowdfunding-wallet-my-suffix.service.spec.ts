...
describe('Service Tests', () => {
    ...
    describe('CrowdfundingWalletMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CrowdfundingWalletMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/crowdfunding-wallets';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CrowdfundingWalletMySuffix', () => {
