...
public class NuoApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(NuoApp.class);

    private final Environment env;

    public NuoApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(NuoApp.class);
