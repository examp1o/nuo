...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.Bulletin.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Project.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.CrowdfundingWallet.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Investment.class.getName(), jcacheConfiguration);
